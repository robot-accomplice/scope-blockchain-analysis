...
// Re-export domain types so existing `crate::cli::address_book::X` paths keep working.
pub use scope::domain::address_book::{
    AddressBook, AddressBookSummary, AddressSummary, ChainBalance, TokenSummary, WatchedAddress,
...
mod tests {
    ...
    use scope::chains::{ChainClient, ChainClientFactory, DexDataSource};
